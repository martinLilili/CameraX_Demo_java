package com.awo.mycameraxstudy.BlazeFace;
...
public class BlazeFace {
    ...
    public List<RectF> detect(Bitmap bitmap) {
        if (cropToFrameTransform == null) {
            ...
            cropBitmap = Bitmap.createBitmap(128, 128, Bitmap.Config.ARGB_8888);
        }
...
//        Trace.beginSection("preprocessBitmap");
        ...
        cropBitmap.getPixels(intValues, 0, INPUT_SIZE_WIDTH, 0, 0, INPUT_SIZE_WIDTH, INPUT_SIZE_HEIGHT);
...
//        Trace.endSection(); // "detect"
    ...
    private List<RectF> WeightedNonMaxSuppression(List<IndexedScore> indexed_scores,
        ...
        while (!remained_indexed_scores.isEmpty()) {
            ...
            if (cropToFrameTransform != null)
            cropToFrameTransform.mapRect(weighted_location);
